...
"")
        ...
        self.horizontalLayoutWidget.setGeometry(QRect(40, 150, 321, 80))
        ...
        self.label.setGeometry(QRect(100, 60, 201, 61))
    ...
    def retranslateUi(self, Form_2):
        Form_2.setWindowTitle(QCoreApplication.translate("Form_2", u"Check_Update", None))
