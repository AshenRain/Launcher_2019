...
def bp_3_browse():
    global filePath
    filePath = QtGui.QFileDialog.getExistingDirectory(Dialog,"Select Directory","C:\\Program Files (x86)\\Steam\\steamapps\\common\\Supreme Commander Forged Alliance")
    if filePath != '0':
...
ui.plainTextEdit.setPlainText("Youtube channel - ImperatoR Arthas_DK\n"
"\n"
"https://www.youtube.com/channel/UCBNDD56Y3-lKx2N5qsbOdaA\n"
"\n"
